...
const CHALLENGES = [
  {
    ...
    trending: true,
    featured: true,
    summary: "Help us cut single-use plastic by 80% across our European supply chain with circular packaging concepts."
  },
  {
    id: "ch-2",
    ...
    trending: true,
    featured: true,
    summary: "Prototype a multilingual support copilot grounded on our knowledge base with measurable deflection rates."
  },
  {
    id: "ch-3",
  ...
  },
  {
    ...
    recruiting: true,
    featured: true,
    summary: "Build a privacy-first signal pipeline to surface early burnout indicators in remote teams."
  },
  {
    id: "ch-5",
    ...
    recruiting: false,
    trending: true,
    summary: "Encourage citizens to report and protect green corridors across the metropolitan area."
  },
  {
    id: "ch-6",
    ...
    teams: true,
    recruiting: true,
    summary: "Design an open-source sizing tool to help cooperatives plan and finance solar microgrids."
  },
  {
    id: "ch-7",
