...
function TalentMessages() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardShell, { title: "Messages", badge: "Espace talent", items: TALENT_NAV, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid h-[calc(100vh-180px)] gap-4 md:grid-cols-[320px_1fr]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col rounded-3xl border border-border bg-card p-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-3 flex-1 space-y-1 overflow-y-auto", children: MESSAGES.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setSel(m.id), className: `flex w-full items-center gap-3 rounded-2xl p-2 text-left transition-all ${sel === m.id ? "bg-accent" : "hover:bg-accent/50"}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-10 w-10 place-items-center rounded-full bg-accent text-xl", children: m.avatar }),
        ...
        m.unread && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-2 w-2 rounded-full bg-coral" })
      ] }) }, m.id)) })
    ] }),
